...
const DrawingCanvas = forwardRef(({ initialData, onChange, height = 600, width = 900, scale = 100 }, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    ...
    getPolygonData: () => {
      ...
      const shape = objects.find(o => (o.type === 'polygon' || o.type === 'rect') && !o.excludeFromExport);
  ...
  const addFloorSlab = () => {
    ...
    fc.add(slab);
    for (let i = 0; i < 10; i++) fc.add(new fabric.Line([400 + i * 15, 400, 400 + i * 15, 500], { stroke: '#ccc', strokeWidth: 1, selectable: false }));
    fc.renderAll();
  };
  ...
  const addFenceLine = () => {
    ...
    for (let i = 0; i < 5; i++) fc.add(new fabric.Rect({ left: 400 + i * 50 - 3, top: 300, width: 6, height: 40, fill: '#8b4513', stroke: '#000', strokeWidth: 1 }));
    fc.renderAll();
  };
  ...
  const addHatch = () => {
    ...
    fc.add(rect);
    for (let i = 0; i < 6; i++) fc.add(new fabric.Line([700 + i * 15, 400, 700 + i * 15, 460], { stroke: '#ccc', strokeWidth: 1, selectable: false }));
    for (let i = 0; i < 4; i++) fc.add(new fabric.Line([700, 400 + i * 20, 780, 400 + i * 20], { stroke: '#ccc', strokeWidth: 1, selectable: false }));
    fc.renderAll();
  };
