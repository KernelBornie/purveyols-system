...
const DrawingForm = () => {
  ...
  }, [activeId]); // re‑init when tab changes
  ...
  const switchDrawing = (id) => {
    ...
    saveCurrentDrawingData(); // save current before switching
    setActiveId(id);
  };
  ...
  // ─── Save / Load all drawings to localStorage ────────────────────
  ...
  return (
    <Box sx={{ p: 2 }}>
      <Typography variant="h5" gutterBottom>🏗️ Professional Drawing Suite (Multi‑Drawing)</Typography>
